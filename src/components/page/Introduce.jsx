    ...
    <Layout>
      ...
      >
        ...
        <div style={{ width: "35%", height: "fit-content", marginTop: "20px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "flex-start", alignItems: "center" }}>
            <p style={{ flex: 1, fontSize: "18px" }}>국적</p>
            <p style={{ flex: 1, fontSize: "18px" }}>신드롬 행성</p>
          </div>
          <div style={{ display: "flex", justifyContent: "flex-start", alignItems: "center" }}>
            <p style={{ flex: 1, fontSize: "18px" }}>생년월일</p>
            <p style={{ flex: 1, fontSize: "18px" }}>☺☺☺☺-☺☺-☺☺</p>
          </div>
          <div style={{ display: "flex", justifyContent: "flex-start", alignItems: "center" }}>
            <p style={{ flex: 1, fontSize: "18px" }}>데뷔</p>
            <p style={{ flex: 1, fontSize: "18px" }}>2018년 싱글 Benefits</p>
          </div>
          <div style={{ display: "flex", justifyContent: "flex-start", alignItems: "center" }}>
            <p style={{ flex: 1, fontSize: "18px" }}>크루</p>
            <p style={{ flex: 1, fontSize: "18px" }}>Filot Club</p>
          </div>
          <div style={{ display: "flex", justifyContent: "flex-start", alignItems: "center" }}>
            <p style={{ flex: 1, fontSize: "18px" }}>레이블</p>
            <p style={{ flex: 1, fontSize: "18px" }}>Beautiful Noise</p>
          </div>
        </div>
      </section>
        ...
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", width: "35%", height: "fit-content", marginTop: "20px" }}>
          <div style={{ display: "flex", justifyContent: "space-around", alignItems: "center", width: "50%" }}>
            ...
            <a target={"_blank"} rel={"noreferrer"} href={"https://www.youtube.com/channel/UCFPCZLYfZj0Ehu2it-HuQiQ"}>
              <img style={{ width: "40px", objectFit: "cover" }} src={youtube} alt={"youtube logo"} />
            </a>
            <a target={"_blank"} rel={"noreferrer"} href={"https://soundcloud.com/ziorpark"}>
              <img style={{ width: "40px", objectFit: "cover" }} src={soundcloud} alt={"soundcloud logo"} />
            </a>
          </div>
        </div>
      </section>
